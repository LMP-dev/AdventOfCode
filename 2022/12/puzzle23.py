...
def filter_feasible_neighbours(
...
def dijkstra(heights: np.ndarray, start: tuple[int], end: tuple[int]):
    ...
    while not finished:
        ...
        neighbours = filter_feasible_neighbours(heights, node, visited)
...
def main() -> None:
    ...
    print(dijkstra(height_grid, start, end))
